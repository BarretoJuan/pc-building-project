...
int nFactura=1;
   ...
   File factura = new File("src/Facturas/Factura "+nFactura+".txt");
      ...
      exito=false;
        ...
        rsscalelabel.RSScaleLabel.setScaleLabel(jLabel1, "src/Resources/check.png");
    }
    ...
    Runtime runtime = Runtime.getRuntime(); //runtime ejecutable para ejecutar el bloc de notas de windows y abrir la factura creada
         
    try {
        Process process = runtime.exec("C:\\Windows\\system32\\notepad.exe C:\\Users\\juan2\\OneDrive\\Escritorio\\pc building\\mavenproject1\\src\\PRUEBAPROYECTO\\src\\Facturas\\Factura "+nFactura+".txt");

    } catch (IOException ex) {
        JOptionPane.showMessageDialog(null, "No se pudo cargar el directorio automaticamente, busque su archivo en el directorio src/Facturas/PRUEBA/Factura "+nFactura+".txt");
